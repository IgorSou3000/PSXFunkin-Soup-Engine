...
void Back_Week5_DrawBG(StageBack *back)
{
	...
	//Draw boppers
	static struct Back_Week5_LowerBop
	{
		RECT src;
		RECT_FIXED dst;
	} lbop_piece[] = {
		...
		{{41, 125, 69, 130}, {FIXED_DEC(164,1), FIXED_DEC(-52,1), FIXED_DEC(69,1), FIXED_DEC(130,1)}},
	};
	
	struct Back_Week5_LowerBop *lbop_p = lbop_piece;
	...
	static struct Back_Week5_FloorPiece
	{
		RECT src;
		fixed_t scale;
	} floor_piece[] = {
	...
	struct Back_Week5_FloorPiece *floor_p = floor_piece;
	...
	//Draw boppers
	static struct Back_Week5_UpperBop
	{
		RECT src;
		RECT_FIXED dst;
	} ubop_piece[] = {
	...
	struct Back_Week5_UpperBop *ubop_p = ubop_piece;
