...
static const CharFrame char_bf_frame[] = {
	...
	{BF_ArcMain_BF4, {  0,   0, 103, 104}, { 53,  96}}, //16 sweat 1
	{BF_ArcMain_BF4, {104,   0, 103, 104}, { 53,  96}}, //17 sweat 2
	{BF_ArcMain_BF4, {  0, 105, 102, 104}, { 53,  97}}, //18 sweat 3
	{BF_ArcMain_BF4, {103, 105, 103, 104}, { 53,  97}}, //19 sweat 4
...
static const Animation char_bf_anim[PlayerAnim_Max] = {
	...
	{2, (const u8[]){16, 17, 18, 19, ASCR_CHGANI, CharAnim_Idle}},      //PlayerAnim_Sweat

	{3, (const u8[]){28, 29, 30, 31, 31, 31, 31, 31, 31, 31, ASCR_CHGANI, PlayerAnim_Dead1}}, //PlayerAnim_Dead0
	{3, (const u8[]){31, ASCR_REPEAT}},                                                       //PlayerAnim_Dead1
	{4, (const u8[]){32, 33, 34, 35, 35, 35, 35, 35, 35, 35, ASCR_CHGANI, PlayerAnim_Dead3}}, //PlayerAnim_Dead2
