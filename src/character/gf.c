...
static const CharFrame char_gf_frame[] = {
	...
	{GF_ArcMain_GF3, {  0,   0,  79, 100}, { 35,  77}}, //17 scary 1
	{GF_ArcMain_GF3, { 79,   0,  78, 100}, { 35,  78}}, //18 scary 2
	{GF_ArcMain_GF3, {157,   0,  78, 101}, { 34,  79}}, //19 scary 3
	{GF_ArcMain_GF3, {  0, 110,  79,  99}, { 35,  77}}, //20 scary 4

	{GF_ArcMain_GF3, { 81, 103,  75, 108}, { 36,  77}}, //21 cheer 1
	{GF_ArcMain_GF3, {159, 103,  77, 107}, { 37,  77}}, //22 cheer 2
	
	{GF_ArcScene_0, {  0,   0,  75, 102}, { 39,  71}}, //23 left 1
	{GF_ArcScene_0, { 76,   0,  77, 103}, { 41,  72}}, //24 left 2
	
	{GF_ArcScene_0, {154,   0,  79, 102}, { 37,  71}}, //25 down 1
	{GF_ArcScene_0, {  0, 103,  78, 104}, { 37,  72}}, //26 down 2
	
	{GF_ArcScene_0, { 79, 104,  79, 108}, { 39,  78}}, //27 up 1
	{GF_ArcScene_0, {159, 104,  79, 109}, { 39,  78}}, //28 up 2
	
	{GF_ArcScene_1, {  0,   0,  81, 102}, { 41,  71}}, //29 right 1
	{GF_ArcScene_1, { 81,   0,  76, 103}, { 36,  72}}, //30 right 2
};

static const Animation char_gf_anim[CharAnim_Max] = {
	{0, (const u8[]){ASCR_CHGANI, CharAnim_LeftAlt}},                        //CharAnim_Idle
	{2, (const u8[]){23, 24, ASCR_BACK, 1}},                                 //CharAnim_Left
	...
	{2, (const u8[]){21, 22, ASCR_BACK, 1}},                                 //CharAnim_UpAlt
			...
			if (stage.note_scroll >= 0)
			{
				switch (stage.stage_id)
				{
					case StageId_1_4: //Tutorial cheer
						...
						break;
					case StageId_1_1: //Bopeebo cheer
